#!/bin/bash
#SBATCH --job-name=mpo-full-asym
#SBATCH --output=slurm-mpo-full-asym-%j.out
...
set -euo pipefail
cd /scratch/simba/Learning_Lindbladian/mpo_asymmetry_full_test
...
python -u run_mpo_full_asymmetry.py
echo "End:   $(date)"
